...
class Commit {
  ...
  get sha() { return this.key; }
  set sha(val) { return false;}
  
  addBranch(b) { this.branches.push(b); }
  ...
  get html() { return this.htmlNode;}
  set html(node) { this.htmlNode = node; }
...
class Branch {
  constructor(name, baseCommit, commits) {
    ...
    _.each(this.commits, c => { c.addBranch(this); });
  }
  ...
  get html() { return this.htmlNode;}
  set html(node) { this.htmlNode = node; }
  static get BranchList () { return BranchList; }
  static addBranch(branch) { BranchList.push(branch); }
...
var b1 = new Branch("master", undefined, [
  new Commit("a123"),
  new Commit("a456"),
  new Commit("a789"),
]);

var b3 = new Branch("feature_2", b1.commits[1], [
  new Commit("c123"),
  new Commit("c456"),
])
/*
...
var b4 = new Branch("feature_3", b3.commits[1], [
  new Commit("d123"),
  new Commit("d456"),
])

var b2 = new Branch("feature_1", b3.commits[1], [
  new Commit("b123"),
  new Commit("b456"),
])
