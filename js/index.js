...
var Colors = ["#cbf", "#bdf", "#fac", "#e7d", "#957"];

var MixColors = ["#abf", "#2df", "#dac", "#b7d", "#c57"];
...
var Commit = (function () {
  ...
  Commit.prototype.addBranch = function addBranch(b) {
    this.branches.push(b);
  };

  Commit.find = function find(sha) {
  ...
  Commit.addCommit = function addCommit(commit) {
...
var Branch = (function () {
  function Branch(name, baseCommit, commits) {
    var _this = this;
    ...
    _.each(this.commits, function (c) {
      c.addBranch(_this);
    });
  }

  Branch.prototype.addCommit = function addCommit(sha) {
    this.commits.push(sha);
  };

  Branch.addBranch = function addBranch(branch) {
    BranchList.push(branch);
  };

  Branch.selectColor = function selectColor() {
